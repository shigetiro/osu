...
namespace osu.Game.Rulesets.Space.Replays
{
    public class SpaceFramedReplayInputHandler : FramedReplayInputHandler<SpaceReplayFrame>
    {
        ...
        protected override void CollectReplayInputs(List<IInput> inputs)
        {
            ...
            var screenSpacePosition = GamefieldToScreenSpace(position);

            // System.Diagnostics.Debug.WriteLine($"SpaceFramedReplayInputHandler: Time={CurrentTime}, Pos={position}, ScreenPos={screenSpacePosition}");
