...
namespace osu.Game.Rulesets.Space.UI
{
    ...
    public partial class DrawableSpaceRuleset : DrawableRuleset<SpaceHitObject>
    {
        ...
        private SpaceReplayRecorder replayRecorder;
        ...
        protected override ReplayRecorder CreateReplayRecorder(Score score) => replayRecorder = new SpaceReplayRecorder(score, (SpaceRuleset)Ruleset);
        ...
        protected override void LoadComplete()
        {
            ...
            if (replayRecorder != null)
                replayRecorder.ScreenSpaceToGamefield = ((SpacePlayfield)Playfield).ScreenSpaceToGamefield;
        }
    }
}
